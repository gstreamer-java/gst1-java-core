...
public interface GstCapsAPI extends com.sun.jna.Library {
    ...
    @CallerOwnsReturn Caps gst_caps_merge(Pointer caps1, @Invalidate Caps caps2);
    @CallerOwnsReturn Caps gst_caps_merge(@IncRef Caps caps1, @Invalidate Caps caps2);
    ...
    @CallerOwnsReturn Caps gst_caps_truncate(@IncRef Caps caps);
    ...
    @CallerOwnsReturn Caps gst_caps_normalize(@IncRef Caps caps);
    @CallerOwnsReturn Caps gst_caps_simplify(@IncRef Caps caps);
