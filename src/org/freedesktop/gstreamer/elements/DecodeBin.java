...
public class DecodeBin extends Bin {
    ...
    public DecodeBin(String name) {
        super(Element.makeRawElement(DecodeBin.GST_NAME, name));
    }
    ...
    public void connect(final UNKNOWN_TYPE listener) {
        this.connect(UNKNOWN_TYPE.class, listener, new GstCallback() {
    ...
    public void connect(final AUTOPLUG_CONTINUE listener) {
        this.connect(AUTOPLUG_CONTINUE.class, listener, new GstCallback() {
            @SuppressWarnings("unused")
    ...
    public void connect(final AUTOPLUG_FACTORIES listener) {
        this.connect(AUTOPLUG_FACTORIES.class, listener, new GstCallback() {
            @SuppressWarnings("unused")
    ...
    public void connect(final AUTOPLUG_SORT listener) {
        this.connect(AUTOPLUG_SORT.class, listener, new GstCallback() {
            @SuppressWarnings("unused")
    ...
    public void connect(final DRAINED listener) {
        this.connect(DRAINED.class, listener, new GstCallback() {
            @SuppressWarnings("unused")
