...
public class TagList extends MiniObject {
	...
	private static Initializer initializer() {
		final Pointer ptr_new_tag_list = TagList.gst.ptr_gst_tag_list_new_empty();
		return NativeObject.initializer(ptr_new_tag_list);
	}
    ...
    public int getValueCount(String tag) {
        return TagList.gst.gst_tag_list_get_tag_size(this, tag);
    }
    ...
    public Object getValue(String tag, int index) {
        TagGetter get = MapHolder.getterMap.get(TagList.getTagType(tag));
    ...
    public List<String> getTagNames() {
        ...
        TagList.gst.gst_tag_list_foreach(this, new GstTagListAPI.TagForeachFunc() {
            @Override
    ...
    public TagList merge(TagList list2, TagMergeMode mode) {
        return TagList.gst.gst_tag_list_merge(this, list2, mode);
    }
    ...
    private static GType getTagType(String tag) {
        ...
        MapHolder.tagTypeMap.put(tag, type = TagList.gst.gst_tag_get_type(tag));
        return type;
    }
        ...
        private static final Map<GType, TagGetter> getterMap = new HashMap<GType, TagGetter>() {{
           this.put(GType.INT, new TagGetter() {
				...
				public Object get(TagList tl, String tag, int index) {
                    int[] value = { 0 };
                    TagList.gst.gst_tag_list_get_int_index(tl, tag, index, value);
                    return value[0];
                }
            });
            this.put(GType.UINT, new TagGetter() {
				...
				public Object get(TagList tl, String tag, int index) {
                    int[] value = { 0 };
                    TagList.gst.gst_tag_list_get_uint_index(tl, tag, index, value);
                    return value[0];
                }
            });
            this.put(GType.INT64, new TagGetter() {
				...
				public Object get(TagList tl, String tag, int index) {
                    long[] value = { 0 };
                    TagList.gst.gst_tag_list_get_int64_index(tl, tag, index, value);
                    return value[0];
                }
            });
            this.put(GType.DOUBLE, new TagGetter() {
				...
				public Object get(TagList tl, String tag, int index) {
                    double[] value = { 0d };
                    TagList.gst.gst_tag_list_get_double_index(tl, tag, index, value);
                    return value[0];
                }
            });
            this.put(GType.STRING, new TagGetter() {
				...
				public Object get(TagList tl, String tag, int index) {
                    Pointer[] value = { null };
                    TagList.gst.gst_tag_list_get_string_index(tl, tag, index, value);
                    if (value[0] == null) {
                        return null;
                    }
            ...
            this.put(GDate.GTYPE, new TagGetter() {
				...
				public Object get(TagList tl, String tag, int index) {
                    ...
                    TagList.gst.gst_tag_list_get_date_index(tl, tag, index, value);
