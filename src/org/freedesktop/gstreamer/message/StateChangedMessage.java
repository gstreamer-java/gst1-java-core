...
public class StateChangedMessage extends Message {
    private static interface API extends GstMessageAPI {
    	@CallerOwnsReturn Pointer ptr_gst_message_new_state_changed(GstObject src, State oldstate, State newstate, State pending);
    }
    ...
    public StateChangedMessage(GstObject src, State old, State current, State pending) {
        super(NativeObject.initializer(StateChangedMessage.gst.ptr_gst_message_new_state_changed(src, old, current, pending)));
    }
    ...
    public State getOldState() {
        ...
        StateChangedMessage.gst.gst_message_parse_state_changed(this, state, null, null);
        return state[0];
    }
    ...
    public State getNewState() {
        State[] state = new State[1];
        StateChangedMessage.gst.gst_message_parse_state_changed(this, null, state, null);
        return state[0];
    }
    ...
    public State getPendingState() {
        State[] state = new State[1];
        StateChangedMessage.gst.gst_message_parse_state_changed(this, null, null, state);
        return state[0];
    }
}
