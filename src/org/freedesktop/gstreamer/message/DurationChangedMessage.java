...
public class DurationChangedMessage extends Message {
    private static interface API extends GstMessageAPI {
    	@CallerOwnsReturn Pointer ptr_gst_message_new_duration_changed(GstObject src);
    }
    ...
    public DurationChangedMessage(GstObject src) {
        this(NativeObject.initializer(DurationChangedMessage.gst.ptr_gst_message_new_duration_changed(src)));
    }
